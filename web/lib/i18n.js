...
export const dictionaries = {
  pt: {
    ...
    "home.prereqs.github": "GitHub autenticado (gh auth login -s read:project ou GH_TOKEN com scope read:project)",
    ...
    "running.launch.sessionHint": "Passos com o mesmo index de sessão (S1, S2…) retomam a mesma conversa do Claude — o contexto do passo anterior é herdado, economizando tokens.",
    "running.launch.session": "Sessão",
    "running.launch.session.new": "Nova sessão",
    "running.launch.session.existing": "Sessão",
    "running.launch.session.ofStep": "Sessão do passo",
    ...
    // Usage
    "usage.title": "Usage",
    "usage.subtitle": "Custo, tokens e tempo das execuções de agentes.",
    "usage.loadError": "Falha ao carregar os dados de uso.",
    "usage.empty": "Nenhuma execução registrada ainda.",
    "usage.emptyPeriod": "Nenhuma execução no período selecionado.",
    "usage.clear": "Limpar dados",
    "usage.clearConfirm": "Apagar TODOS os registros de uso? Esta ação não pode ser desfeita.",
    "usage.filter.allRepos": "Todos os boards",
    "usage.period.1d": "1d",
    "usage.period.7d": "7d",
    "usage.period.30d": "30d",
    "usage.period.90d": "90d",
    "usage.summary.cost": "Custo",
    "usage.summary.tokens": "Tokens",
    "usage.summary.input": "entrada",
    "usage.summary.output": "saída",
    "usage.summary.time": "Tempo de execução",
    "usage.summary.tasks": "tarefas executadas",
    "usage.summary.execs": "Execuções",
    "usage.summary.failed": "com falha",
    "usage.metric.tokens": "Tokens",
    "usage.metric.cost": "Custo",
    "usage.metric.time": "Tempo",
    "usage.metric.execs": "Execuções",
    "usage.tooltip.total": "total",
    "usage.tooltip.execs": "execuções",
    "usage.table.cards.title": "Por card",
    "usage.table.agents.title": "Por agente",
    "usage.table.card": "Card",
    "usage.table.agent": "Agente",
    "usage.table.tokens": "Tokens",
    "usage.table.cost": "Custo",
    "usage.table.time": "Tempo",
    "usage.table.agents": "Agentes",
    "usage.table.cards": "Cards",
    "usage.table.noCard": "Sem card",
    "usage.table.empty": "Sem dados no período.",
  ...
  en: {
    ...
    "home.prereqs.github": "GitHub authenticated (gh auth login -s read:project or GH_TOKEN with read:project scope)",
    ...
    "running.launch.sessionHint": "Steps with the same session index (S1, S2…) resume the same Claude conversation — the previous step's context is inherited, saving tokens.",
    "running.launch.session": "Session",
    "running.launch.session.new": "New session",
    "running.launch.session.existing": "Session",
    "running.launch.session.ofStep": "Session of step",
    ...
    // Usage
    "usage.title": "Usage",
    "usage.subtitle": "Cost, tokens and time of agent executions.",
    "usage.loadError": "Failed to load usage data.",
    "usage.empty": "No executions recorded yet.",
    "usage.emptyPeriod": "No executions in the selected period.",
    "usage.clear": "Clear data",
    "usage.clearConfirm": "Delete ALL usage records? This action cannot be undone.",
    "usage.filter.allRepos": "All boards",
    "usage.period.1d": "1d",
    "usage.period.7d": "7d",
    "usage.period.30d": "30d",
    "usage.period.90d": "90d",
    "usage.summary.cost": "Cost",
    "usage.summary.tokens": "Tokens",
    "usage.summary.input": "input",
    "usage.summary.output": "output",
    "usage.summary.time": "Execution time",
    "usage.summary.tasks": "tasks executed",
    "usage.summary.execs": "Executions",
    "usage.summary.failed": "failed",
    "usage.metric.tokens": "Tokens",
    "usage.metric.cost": "Cost",
    "usage.metric.time": "Time",
    "usage.metric.execs": "Executions",
    "usage.tooltip.total": "total",
    "usage.tooltip.execs": "executions",
    "usage.table.cards.title": "By card",
    "usage.table.agents.title": "By agent",
    "usage.table.card": "Card",
    "usage.table.agent": "Agent",
    "usage.table.tokens": "Tokens",
    "usage.table.cost": "Cost",
    "usage.table.time": "Time",
    "usage.table.agents": "Agents",
    "usage.table.cards": "Cards",
    "usage.table.noCard": "No card",
    "usage.table.empty": "No data in this period.",
