...
function SidebarContent({
  ...
  return (
    <div className="flex h-full flex-col">
      {/* Marca (leva à home) + versão/update no final da linha */}
      <div className="flex items-center gap-1.5 px-3 py-3">
        <button
          type="button"
          onClick={() => onNavigate("/")}
          className="flex items-center gap-1.5 outline-none focus-visible:ring-2 focus-visible:ring-ring/50"
        >
