...
* enhance concurrency management and log handling ([5f35edc](https://github.com/rafaelsene01/agent-flow/commit/5f35edc4f8350a4973e35c9886e4c96cbe46ed62))
...
* enhance SkillCreatorModal with AI mode and validation ([bd2bbd6](https://github.com/rafaelsene01/agent-flow/commit/bd2bbd6f83043a24ab3bf96c5146392c4e427155))
...
* implement continuous background polling for item cache refresh ([a9da20e](https://github.com/rafaelsene01/agent-flow/commit/a9da20e8b849535783052fe0ea611eeeb168b886))
* improve agent prompt construction with skill handling ([bb0c645](https://github.com/rafaelsene01/agent-flow/commit/bb0c6458026c9e21bc460ba498af46768744b95d))
...
* enhance UI and internationalization support across components ([34bd10d](https://github.com/rafaelsene01/agent-flow/commit/34bd10dadd3305a0a61638c2415c34d74967fb83))
...
* ensure dialog opens correctly in FileContentModal ([214af2c](https://github.com/rafaelsene01/agent-flow/commit/214af2cb09f574c00ef468c653d86278c79ef829))

## [1.14.1](https://github.com/rafaelsene01/agent-flow/compare/v1.14.0...v1.14.1) (2026-06-21)


### Bug Fixes

* update installation command in README ([e4e834e](https://github.com/rafaelsene01/agent-flow/commit/e4e834e253643259bf7cd45d3f5e1f4ab1004932))
